...
``` r
prec_2018 = 
  readxl::read_excel("./data/Trash-Wheel-New.xlsx", sheet = "2018 Precipitation", range = "A2:B14") %>%
  janitor::clean_names() %>% 
  mutate(year = "2018")
prec_2018
```
...
``` r
prec_2019 = 
  readxl::read_excel("./data/Trash-Wheel-New.xlsx", sheet = "2019 Precipitation", range = "A2:B14") %>% 
  janitor::clean_names() %>% 
  mutate(year = "2019")
prec_2019
```
